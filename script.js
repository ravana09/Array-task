...
xhr.onload = function () {
    ...
    let currenciesArray = data.filter((value) => {
        return value.currencies && value.currencies.USD;

    }
    )
    currenciesArray.forEach(country => {
        console.log(`
        US DOLLAR COUNTRIES :${country.name.common}`);
    });
